...
class Category(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('mp_news:category', kwargs={"slug": self.slug})
...
class Tag(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('mp_news:tag', kwargs={"slug": self.slug})
...
class Post(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('mp_news:post', kwargs={"slug": self.slug})
